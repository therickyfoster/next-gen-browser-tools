...
#### **Basic Tier** (2GB RAM, integrated graphics)
...
### **Scenario 4: Medical Imaging Review (Healthcare)**
...
**Maintenance Policy**: Quarterly major updates, monthly security/performance patches
